  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab1-tab1-module"], {
    ...
    function srcAppTab1Tab1PageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var Tab1Page = /*#__PURE__*/function () {
        function Tab1Page(storageService, authService) {
        ...
        _createClass(Tab1Page, [{
          ...
          value: function ngOnInit() {
            ...
            this.storageService.get(_config_auth_constants__WEBPACK_IMPORTED_MODULE_3__["AuthConstants"].AUTH).then(function (data) {
              _this.payload = data;

              _this.authService.getUserByUsername(data['sub']).subscribe(function (res) {
                _this.profiledata = res[0];
              });

              _this.authService.getsensorData().then(function (data) {
          ...
          value: function doRefresh(event) {
            ...
            this.storageService.get(_config_auth_constants__WEBPACK_IMPORTED_MODULE_3__["AuthConstants"].AUTH).then(function (data) {
              ...
              _this2.authService.getUserByUsername(data['sub']).subscribe(function (res) {
                _this2.profiledata = res[0];
              });
            });
            setTimeout(function () {
          ...
          value: function createBarChart() {
            ...
            this.authService.getsensorData().then(function (data) {
              _this3.sensordata = data;
              var lastOne = _this3.sensordata;
              var payloadResult = lastOne["payload"];
              _this3.availablePlace = payloadResult === "1";
            });
