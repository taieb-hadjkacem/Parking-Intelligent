...
/* harmony import */ var _config_auth_constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../config/auth-constants */ "./src/config/auth-constants.ts");
...
let LoginPage = class LoginPage {
    ...
    ngOnInit() {
        this.authService.preSignIn(this.clientId, this.codeChallenge).subscribe((res) => {
        ...
        if (this.validateInputs()) {
            this.authService.login(this.postData).subscribe((res) => {
                if (res.authorizationCode) {
                    ...
                    this.authService.postSignIn(this.authorizationCode, this.codeVerifier, this.postData.username).subscribe((res) => {
                        if (res.token) {
                            // Storing the User data.
                            this.storageService.store(_config_auth_constants__WEBPACK_IMPORTED_MODULE_4__["AuthConstants"].AUTH, res.token);
