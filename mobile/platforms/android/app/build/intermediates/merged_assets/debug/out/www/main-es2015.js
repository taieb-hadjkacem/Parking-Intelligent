...
const routes = [
    ...
    {
        path: '',
        loadChildren: () => Promise.all(/*! import() | auth-login-login-module */[__webpack_require__.e("default~auth-login-login-module~auth-signup-signup-module~tab1-tab1-module"), __webpack_require__.e("auth-login-login-module")]).then(__webpack_require__.bind(null, /*! ./auth/login/login.module */ "./src/app/auth/login/login.module.ts")).then(m => m.LoginPageModule)
    },
    {
        path: 'signup',
        loadChildren: () => Promise.all(/*! import() | auth-signup-signup-module */[__webpack_require__.e("default~auth-login-login-module~auth-signup-signup-module~tab1-tab1-module"), __webpack_require__.e("auth-signup-signup-module")]).then(__webpack_require__.bind(null, /*! ./auth/signup/signup.module */ "./src/app/auth/signup/signup.module.ts")).then(m => m.SignupPageModule)
    }
];
...
module.exports = __webpack_require__(/*! C:\Users\G I E\Keep-Me-Safe-Project-main\Frontend\src\main.ts */"./src/main.ts");
