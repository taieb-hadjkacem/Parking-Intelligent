...
let Tab1Page = class Tab1Page {
    ...
    ngOnInit() {
        this.storageService.get(_config_auth_constants__WEBPACK_IMPORTED_MODULE_3__["AuthConstants"].AUTH).then(data => {
            this.payload = data;
            this.authService.getUserByUsername(data['sub']).subscribe((res) => {
