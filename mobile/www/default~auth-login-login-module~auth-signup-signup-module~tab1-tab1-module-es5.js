(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~auth-login-login-module~auth-signup-signup-module~tab1-tab1-module"], {
    /***/
    ...
    function srcAppServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AuthService = /*#__PURE__*/function () {
        ...
        _createClass(AuthService, [{
          ...
          key: "preSignIn",
          value: function preSignIn(clientId, codeChallenge) {
            var data = {
              clientId: clientId,
          ...
          key: "postSignIn",
          value: function postSignIn(authorizationCode, codeVerifier, username) {
            var data = {
          ...
          value: function logout() {
            ...
            this.storageService.removeStorageItem(_config_auth_constants__WEBPACK_IMPORTED_MODULE_5__["AuthConstants"].AUTH).then(function (res) {
          ...
          key: "processSign",
          value: function processSign(postData) {}
        }, {
          key: "getsensorData",
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      _context.next = 2;
                      return this.httpService.get("mqtts").toPromise().then(function (data) {
                        _this3.sensorData = data;
                        console.log('Promise resolved.');
                      });

                    case 2:
                      return _context.abrupt("return", this.sensorData);
    ...
    function srcAppServicesStorageServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var StorageService = /*#__PURE__*/function () {
        ...
        _createClass(StorageService, [{
              ...
              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                      ret = _context3.sent;
                      return _context3.abrupt("return", Object(jwt_decode__WEBPACK_IMPORTED_MODULE_3__["default"])(JSON.parse(unescape(atob(ret.value)))));
          ...
          value: function removeStorageItem(storageKey) {
    ...
    /***/
    function srcConfigAuthConstantsTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      AuthConstants.AUTH = 'token';
      ;
      /***/
    }
  }]);
})();
//# sourceMappingURL=default~auth-login-login-module~auth-signup-signup-module~tab1-tab1-module-es5.js.map